...
public partial class BankDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Bank>(entity =>
        {
            ...
            entity.Property(e => e.BankId).ValueGeneratedOnAdd(); // Auto increment
            entity.Property(e => e.Address).HasMaxLength(255).IsUnicode(false);
            entity.Property(e => e.BankName).HasMaxLength(255).IsUnicode(false);
            entity.Property(e => e.ContactEmail).HasMaxLength(255).IsUnicode(false);
            entity.Property(e => e.ContactPhone).HasMaxLength(255).IsUnicode(false);
        ...
        modelBuilder.Entity<Beneficiary>(entity =>
        {
            ...
            entity.Property(e => e.Ifsccode).HasMaxLength(255).IsUnicode(false).HasColumnName("IFSCCode");
        ...
        modelBuilder.Entity<Document>(entity =>
        {
            ...
            entity.Property(e => e.DocType).HasMaxLength(255).IsUnicode(false);
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.Property(e => e.FullName).HasMaxLength(255).IsUnicode(false);
            entity.Property(e => e.Ifsccode).HasMaxLength(255).IsUnicode(false).HasColumnName("IFSCcode");
            entity.Property(e => e.PhoneNumber).HasMaxLength(255).IsUnicode(false);
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.Property(e => e.Status).HasMaxLength(255).HasDefaultValue("Pending");
